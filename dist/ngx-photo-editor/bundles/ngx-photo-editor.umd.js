(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('cropperjs'), require('@ng-bootstrap/ng-bootstrap')) :
    typeof define === 'function' && define.amd ? define('ngx-photo-editor', ['exports', '@angular/core', 'cropperjs', '@ng-bootstrap/ng-bootstrap'], factory) :
    (global = global || self, factory(global['ngx-photo-editor'] = {}, global.ng.core, global.Cropper, global.ngBootstrap));
}(this, (function (exports, core, Cropper, ngBootstrap) { 'use strict';
    ...
    var NgxPhotoEditorService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxPhotoEditorService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgxPhotoEditorService_Factory() { return new NgxPhotoEditorService(); }, token: NgxPhotoEditorService, providedIn: "root" });
    ...
    var NgxPhotoEditorComponent = /** @class */ (function () {
        ...
        NgxPhotoEditorComponent.propDecorators = {
            content: [{ type: core.ViewChild, args: ['ngxPhotoEditorContent', { static: false },] }],
            modalTitle: [{ type: core.Input }],
            aspectRatio: [{ type: core.Input }],
            autoCropArea: [{ type: core.Input }],
            autoCrop: [{ type: core.Input }],
            mask: [{ type: core.Input }],
            guides: [{ type: core.Input }],
            centerIndicator: [{ type: core.Input }],
            viewMode: [{ type: core.Input }],
            modalSize: [{ type: core.Input }],
            modalCentered: [{ type: core.Input }],
            scalable: [{ type: core.Input }],
            zoomable: [{ type: core.Input }],
            cropBoxMovable: [{ type: core.Input }],
            cropBoxResizable: [{ type: core.Input }],
            ...
            imageSmoothingEnabled: [{ type: core.Input }],
            imageSmoothingQuality: [{ type: core.Input }],
            imageCropped: [{ type: core.Output }],
            imageQuality: [{ type: core.Input }],
            imageFormat: [{ type: core.Input }],
            imageUrl: [{ type: core.Input }],
            imageBase64: [{ type: core.Input }],
            imageChanedEvent: [{ type: core.Input }],
    ...
    var NgxPhotoEditorModule = /** @class */ (function () {
        ...
        NgxPhotoEditorModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [ngBootstrap.NgbModalModule],
    ...
    exports.NgxPhotoEditorComponent = NgxPhotoEditorComponent;
    exports.NgxPhotoEditorModule = NgxPhotoEditorModule;
    exports.NgxPhotoEditorService = NgxPhotoEditorService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-photo-editor.umd.js.map
